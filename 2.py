...
# Specify model names for different translations
model_names = {
    "English to Spanish": "Helsinki-NLP/opus-mt-en-es",
    "English to French": "Helsinki-NLP/opus-mt-en-fr",
}

model_name = model_names["English to Spanish"]
...
def TranslateText():
    ...
    if selected_language in model_names:
        model_name = model_names[selected_language]
        model, tokenizer = load_model_and_tokenizer(model_name)
